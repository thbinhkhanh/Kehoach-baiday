...
export default function Users({ user }) {
  ...
  return (
    <Box sx={{ height: "95vh", width: "100vw", display: "flex", gap: 2, p: 2, alignItems: "flex-start" }}>
      {/* Cột trái: Upload + Danh sách file */}
      <Box sx={{ width: "25%", minWidth: 250, display: "flex", flexDirection: "column", gap: 2, height: "95%" }}>
        {/* Upload Card */}
        <Card sx={{ width: "100%", flexShrink: 0, mt: -3 }}>
          <CardContent sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <Typography variant="h5" gutterBottom>📚 Kế hoạch bài dạy</Typography>
            {/* Nhóm chọn môn và lớp */}
              ...
              <Box sx={{ display: "flex", gap: 2 }}>
                ...
                >
                  📤 Tải file
                  {/*<input type="file" accept=".doc,.docx" hidden onChange={handleUpload} />*/}
                  <input
                    type="file"
                    accept=".doc,.docx"
                    multiple
